...
class Game extends Component {
  ...
  render() {
    return (
      <>
        <Helmet>
          <title>Impossible Chess | Can you beat the best bot in the world?</title>
          ...
          <meta property="og:description" content="Can you beat the best bot in the world?" />
                      ...
                      <div className="chess__header">
                        <div className="chess__header__meta">
                          ...
                          <div className="chess__header__turns">
                            ...
                            <span className="silent">Turns: </span>{turns}
                          </div>
                        </div>
                      </div>
                      <Chessboard
